		...
		<div id="content">
			...
			<div id="area-1">
	    		...
	    		<div id="area-1-section">
					...
					<script>
						function challenge(idReq2){
							document.detailedChallenge.idReq.value = idReq2.id;
							document.detailedChallenge.submit();
						}
					</script>
					
					<form name="detailedChallenge" action="detailedchallenge.php" method="get">
	    			...
	    			<div id="section-1" class="section">
							...
							<?php
			    				...
			    				$consulta = "SELECT * FROM requirements WHERE challenge IS NOT NULL AND(user=$idUser OR userC=$idUser) ORDER BY dateC DESC";
								...
								while($row = mysqli_fetch_array($result)){
								  ...
								  <div id="section-1-element">
								  	...
								  	<!-- <img src="data:image/jpeg;base64,<?php echo base64_encode($imagen); ?>" /> -->
								  	 ...
								  	 <img id="<?php echo $row['id'];?>" src="./images/button.jpg" onclick="challenge(this)" width"20px" height="20px"> 
